...
= 2.64 =
* Bug fix "Online booking Close" when using military time such as 13h 30min. Now fixed.
...
= 2.62 =
* Added filter for Offline Reservation addon, to book past booking time. Requires Offline Reservation v1.50 and above.

= 2.60 =
* WP 4.5 ready.
* Added support for  <a title="Row Seats Amenties" href="http://www.rowseatsplugin.com/row-seats-amenities" target="_blank">Row Seats Amenities</a>
* VERY IMPORTANT, DO NOT UPDATE IF YOU HAVE LIVE BOOKINGS. WAIT TILL BOOKINGS ARE PAST (ENDED). BUT, IF YOU DECIDE TO UPDATE ANYWAY, MAKE A DB BACKUP OF ROW SEATS FIRST, JUST IN CASE SHOULD YOU NEED TO.

= 2.58 =
* WP 4.4 ready, it wouldn't take null value for usermod, now patched. Events can now be saved in the calendar.
* Internalization i18n issue with dates in other languages (other than English) caused events not to show, now fixed.
* VERY IMPORTANT, DO NOT UPDATE IF YOU HAVE LIVE BOOKINGS. WAIT TILL BOOKINGS ARE PAST (ENDED). BUT, IF YOU DECIDE TO UPDATE ANYWAY, MAKE A DB BACKUP OF ROW SEATS FIRST, JUST IN CASE SHOULD YOU NEED TO.
