...
if (isset($_POST['showid']) && $_POST['showid'] != '' && isset($_POST['rstaction']) && $_POST['rstaction'] == 'show') {
    $formaction = 'show';
...
if (isset($_POST['showid']) && $_POST['showid'] != '' && isset($_POST['rstaction']) && $_POST['rstaction'] == 'setprice') {
    $showid['id'] = $_POST['showid'];
    $showid = $showid['id'];
...
if (isset($_POST['showid']) && $_POST['showid'] != '' && isset($_POST['rstaction']) && $_POST['rstaction'] == 'delete') {
    $data['id'] = $_POST['showid'];
    rst_shows_operations('delete', $data, '');

}
if (isset($_POST['showid']) && $_POST['showid'] != '' && isset($_POST['rstaction']) && $_POST['rstaction'] == 'edit') {
